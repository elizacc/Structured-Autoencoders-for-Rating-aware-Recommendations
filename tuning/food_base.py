...
if __name__ == "__main__":
    ...
    for batch_size in sizes:
        tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, base_model, device, grid,
                                MVDataset, batch_size=int(batch_size), tensor_model=False)
