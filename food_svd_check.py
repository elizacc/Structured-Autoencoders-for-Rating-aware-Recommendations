...
svd_params = build_svd_model({'rank':96, 'f':1.1}, train_val, data_description)
...
svd_params = build_svd_model({'rank':512, 'f':1.4}, train_val, data_description)
svd_scores = svd_model_scoring(svd_params, testset, data_description)
downvote_seen_items(svd_scores, testset, data_description)
...
svd_params = build_svd_model({'rank':256, 'f':0.8}, train_val, data_description)
svd_scores = svd_model_scoring(svd_params, testset, data_description)
downvote_seen_items(svd_scores, testset, data_description)

make_prediction(svd_scores, holdout, data_description, dcg=True, alpha=6)