...
for batch_size in sizes:
    ...
    tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, triangular_model, device, grid, batch_size=batch_size, tensor_model=True)
...
for batch_size in sizes:
    print('Batch size:', batch_size)
    tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, triangular_banded_model, device, grid, batch_size=batch_size, tensor_model=True)
...
for batch_size in sizes:
    print('Batch size:', batch_size)
    tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, square_root_model, device, grid, batch_size=batch_size, tensor_model=True)
...
for batch_size in sizes:
    print('Batch size:', batch_size)
    tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, twotriangular_model, device, grid, batch_size=batch_size, tensor_model=True)
...
for batch_size in sizes:
    print('Batch size:', batch_size)
    tuning_pipeline_augment(training, testset_valid, holdout_valid, data_description, vartriangular_model, device, grid, batch_size=batch_size, tensor_model=True)

# %% [markdown]
# ## Model: encoder and decoder different, individual rating layer
...
for batch_size in sizes:
    print('Batch size:', batch_size)
    tuning_pipeline(training, testset_valid, holdout_valid, data_description, varindtriangular_model, device, grid, batch_size=batch_size, tensor_model=True)
